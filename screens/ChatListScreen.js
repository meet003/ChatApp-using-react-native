...
const ChatListScreen = props => {
    ...
    const userData = useSelector(state => state.auth.userData); // this give user lodin data
        ...
        <FlatList
            ...
            renderItem={(itemData) => {
                ...
                if (isGroupChat) {
                    ...
                    image = chatData.chatImage;// for image in main  chat page
                }
                else {
    ...
    //     <Button title='Go to Settings' onPress={() => props.navigation.navigate("ChatScreen")
    //     } />
    // </View>
